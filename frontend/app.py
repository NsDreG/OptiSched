...
class OptiSchedApp:
    ...
    def workspace_page(self):
        ...
        self.template_download_section()
        self.upload_timetable_section()
        self.ai_and_timetable_section()

    # ---------- Template Download ----------
    def template_download_section(self):
    ...
    # ---------- Upload Timetable ----------
    def upload_timetable_section(self):
    ...
    # ---------- AI + Timetable ----------
    def ai_and_timetable_section(self):
        left_col, right_col = st.columns([1, 2])  # 1/3 left, 2/3 right
